...
I've tweaked the page to match my [`dotfiles`](https://github.com/Dhanush-777x/dotfiles.git) so check them out as well.
...
>
> If you want to reduce the loading time of the icons, you could install the icon [font](src/fonts) locally and activate
> the option `"localIcons": true` in the config to disable the remote styles
